...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            CATEGORY_MENU: [CallbackQueryHandler(button_handler)],
            SERVICE_DETAIL: [CallbackQueryHandler(button_handler)],
            CALC_CATEGORY: [CallbackQueryHandler(button_handler)],
            CALC_EXTRAS: [CallbackQueryHandler(button_handler)],
            ORDER_NAME: [
            ...
            ORDER_CONFIRM: [CallbackQueryHandler(button_handler)],
        },
        fallbacks=[
